function [ average_groundtruth, path_gt ] = cal_gt(pathtoECG,i)
...
path = sprintf('/home/hanxu/thesis/NewFolder/data/%s',sVideo.name);
mkdir(path);
savepath = sprintf('/home/hanxu/thesis/NewFolder/data/%s/groundtruth%d.mat',sVideo.name,i);
save(savepath,'groundtruth');  
path_gt = savepath;
average_groundtruth = mean(groundtruth');
end
